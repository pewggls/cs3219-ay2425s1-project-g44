...
import { ClipboardCopyIcon, EllipsisIcon, DownloadIcon, Link2Icon, Maximize2Icon } from 'lucide-react'
...
const ActionItems: Array<{
  ...
  { key: 'onView', icon: <Maximize2Icon className="size-4" />, tooltip: 'View image' },
