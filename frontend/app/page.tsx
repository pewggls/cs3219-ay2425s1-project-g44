    ...
    <div className="min-h-screen p-4 bg-white">
      <header className="flex items-center justify-between p-4 border-b">
        <div className="flex items-center gap-2">
          ...
          <Link href="#" className="text-2xl font-bold font-branding text-purple-600" prefetch={false}>PeerPrep</Link>
        </div>
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center font-sans text-black sm:items-start">
        <Image
